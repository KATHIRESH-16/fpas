...
function loadWeeklyCalendar(){
  ...
  days.forEach(d=>{
    const div=document.createElement("div");
    div.style.padding="10px"; div.style.borderRadius="8px"; div.style.minHeight="100px"; div.style.transition="0.3s";
    div.innerHTML=`<b>${d}</b><br>`+
      periods.filter(p=>p.faculty===JSON.parse(localStorage.getItem("user")).id)
