...
function showAdminPanel(){
  ...
  const facList = Object.keys(users).filter(u=>u.startsWith("F"));
  content.innerHTML=`
...
function addPeriod(){
  ...
  facs.forEach(f=>{
    periods.push({faculty:f,day,period:periodName,class:className,time,rem});
  });
...
function showUserPanel(){
  ...
  content.innerHTML=`
    ...
    <select id="urole"><option value="faculty">Faculty</option><option value="admin">Admin</option></select>
